...
-- Misc
create_bind(vars.kbDashboard, hl.dsp.global("caelestia:dashboard"))
...
-- Night light toggle
create_bind(vars.kbNightLight, hl.dsp.exec_cmd("/home/kanishk/.config/hypr/scripts/toggle-nightlight.sh"))
